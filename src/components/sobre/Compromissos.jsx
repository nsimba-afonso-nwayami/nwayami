        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {compromissos.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group relative flex flex-col overflow-hidden bg-white border border-neutral-200/80 rounded-2xl p-6 sm:p-7 hover:border-orange-500/50 hover:shadow-lg transition-all duration-300"
            >
