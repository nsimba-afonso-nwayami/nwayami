      ...
      >
        {slides.map((slide, index) => (
          ...
          >
            {({ isActive }) => (
              <>
                {/* Imagem com Zoom Animado via Framer Motion (Ken Burns) */}
                <motion.div
                ...
                <div className="absolute inset-0 bg-linear-to-t from-neutral-950 via-transparent to-transparent opacity-50 z-10" />
                  ...
                  <div className="max-w-7xl mx-auto px-6 md:px-8 w-full flex justify-center">
                    <div className="max-w-4xl space-y-6 flex flex-col items-center">
                      ...
                      <motion.h1
                        ...
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-50 leading-[1.15] tracking-tight"
                      >
                        {slide.title}{" "}
                      ...
                      {/* Descrição com Animação Staggered */}
                      <motion.p
                        ...
                        className="text-neutral-300 text-base md:text-lg leading-relaxed max-w-2xl font-normal mx-auto"
                      >
                        {slide.desc}
                      </motion.p>

                      {/* Grupo de Ações (CTAs) com Animação */}
                      <motion.div
