...
export default function MapaCta() {
  return (
    <section className="py-28 bg-white text-neutral-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <motion.div
          ...
          className="max-w-3xl mx-auto text-center mb-16 sm:mb-20 space-y-4"
        >
        ...
        {/* Mapa com entrada suave e ligeira escala */}
        <motion.div
          initial={{ opacity: 0, y: 30, scale: 0.98 }}
          whileInView={{ opacity: 1, y: 0, scale: 1 }}
          viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
          className="overflow-hidden rounded-3xl border border-neutral-200/80 shadow-xs hover:shadow-md transition-shadow duration-300"
        >
          <iframe
        ...
        >
          <div className="bg-neutral-50 border border-neutral-200/80 rounded-3xl p-8 md:p-12 lg:p-14 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 shadow-xs">
            ...
            <MotionLink
              ...
              whileTap={{ scale: 0.98 }}
              className="group w-full lg:w-auto inline-flex items-center justify-center gap-3 bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-xl transition-colors duration-300 shadow-sm hover:shadow-lg hover:shadow-orange-500/15 shrink-0 text-sm tracking-wide"
            >
              Fale Connosco
