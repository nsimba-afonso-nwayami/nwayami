      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-6">
          ...
          <p className="text-neutral-400 text-sm leading-7 font-medium">
            Desenvolvemos soluções em engenharia, construção civil, reabilitação
            e consultoria, garantindo qualidade, segurança e compromisso em cada
            projeto corporativo ou residencial.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-neutral-400 text-sm font-medium">
            <div className="flex items-center gap-3 group">
              ...
              <p className="transition-colors duration-300 group-hover:text-neutral-200">
                Luanda, Angola
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 group">
              ...
              <p className="truncate transition-colors duration-300 group-hover:text-neutral-200">
                contacto@nwayami.ao
              </p>
            </div>
          </div>
